	...
	<nav
		...
		<div class="collapse navbar-collapse" id="navbarResponsive">
			<ul class="navbar-nav ms-auto">
				<li class="nav-item mx-0 mx-lg-1"><a class="nav-link py-3 px-0 px-lg-3 rounded" href="/details" style="margin-right: 60px;">Train Details</a></li>
				<li class="nav-item mx-0 mx-lg-1"><a class="nav-link py-3 px-0 px-lg-3 rounded" href="/CustomerDetails" style="margin-right: 60px;">Show Booking Details</a></li>
				<li class="nav-item mx-0 mx-lg-1"><a class="nav-link py-3 px-0 px-lg-3 rounded" href="/logout" style="margin-right: 60px;">Log Out</a></li>
			</ul>
		</div>
	</nav>
	<input type="hidden" id="status" value="<%= request.getAttribute("status") %>">
	<div class="main" style="margin-top: -360px; height: 1400px; background: url('images/registration-img.png');" >
		<!-- Sign up form -->
		<section class="signup">
			<div class="container" style="width: 700px; margin-left: 300px; opacity: 0.8;">
				<div class="signup-content">
					<div class="signup-form">
						<h2 class="form-title">Add New Railways</h2>
